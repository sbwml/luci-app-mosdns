...
local black_list_file = "/etc/mosdns/rule/blacklist.txt"
...
s:tab("black_list", translate("Black Lists"))
...
o = s:taboption("black_list", TextValue, "blacklist", "", "<font color='red'>" .. translate("These domains are always resolved using remote DNS. Please input the domain names of websites, every line can input only one website domain. For example: google.com.") .. "</font>" .. "<font color='#00bd3e'>" .. translate("<br>The list of rules only apply to 'Default Config' profiles.") .. "</font>")
o.rows = 15
o.wrap = "off"
o.cfgvalue = function(self, section) return nixio.fs.readfile(black_list_file) or "" end
o.write = function(self, section, value) nixio.fs.writefile(black_list_file, value:gsub("\r\n", "\n")) end
o.remove = function(self, section, value) nixio.fs.writefile(black_list_file, "") end
o.validate = function(self, value)
    return value
end
